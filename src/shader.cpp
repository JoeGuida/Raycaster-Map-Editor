...
Shader::Shader(const std::string& shaderPath, const std::string& vertexPath, const std::string& fragmentPath) {
    ...
    try {
        // open files
        vertexShaderFile.open(shaderPath + vertexPath);
        fragmentShaderFile.open(shaderPath + fragmentPath);
